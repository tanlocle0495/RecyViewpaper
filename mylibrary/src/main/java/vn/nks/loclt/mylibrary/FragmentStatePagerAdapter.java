package vn.nks.loclt.mylibrary;
 ...
 * valid ID set.</p>
 * <p/>
 * <p>Subclasses only need to implement {@link #getItem(int, android.support.v4.app.Fragment.SavedState)}
...
public abstract class FragmentStatePagerAdapter extends RecyclerView.Adapter<FragmentStatePagerAdapter.FragmentViewHolder> {
    ...
    private SparseArray<android.support.v4.app.Fragment.SavedState> mStates = new SparseArray<>();
    ...
    public void onViewRecycled(FragmentViewHolder holder) {
        ...
        android.support.v4.app.Fragment f = mFragmentManager.findFragmentByTag(tagId + "");
        if (f != null) {
     ...
     */
    public abstract android.support.v4.app.Fragment getItem(int position, android.support.v4.app.Fragment.SavedState savedState);
    ...
    public class FragmentViewHolder extends RecyclerView.ViewHolder implements View.OnAttachStateChangeListener {
        ...
        public void onViewAttachedToWindow(View v) {
            ...
            final android.support.v4.app.Fragment fragmentInAdapter = getItem(getLayoutPosition(), mStates.get(tagId));
        ...
        public void onViewDetachedFromWindow(View v) {
            if (DEBUG) Log.v(TAG, "Removing fragment #");
            final int tagId = genTagId(getLayoutPosition());
            android.support.v4.app.Fragment frag = mFragmentManager.findFragmentByTag(tagId + "");
            if (frag == null) {
                return;
            }
            if (mCurTransaction == null) {
